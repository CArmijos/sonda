...
MySQL - 10.3.32-MariaDB-0ubuntu0.20.04.1 : Database - challengedb
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`challengedb` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
CREATE TABLE `arrendatario` (
  ...
  `rutArrendatario` varchar(45) CHARACTER SET utf8 NOT NULL,
...
insert  into `arrendatario`(`idArrendatario`,`rutArrendatario`,`nombre`,`fechaNacimiento`) values 
(14,'8760213-3','Carlos','1961-03-20 13:03:36'),
(15,'9652585-0','Juana de Arcos','1963-06-27 13:12:27'),
(16,'17485693-K','Silvia Godoy Rojo','1951-03-10 15:19:29');
...
insert  into `arriendos`(`idArriendos`,`idArrendatario`,`idPropietario`,`idPropiedad`,`monto`,`fechaIni`,`fechaFin`) values 
(2,14,2,3,350000,'2022-01-01 18:01:33','2022-02-28 18:01:38'),
(3,15,2,6,720000,'2022-01-01 10:19:14','2022-05-31 10:19:21'),
(4,16,2,7,654000,'2022-01-01 10:20:26','2022-10-31 10:20:32');
...
insert  into `propiedad`(`idPropiedad`,`idPropietario`,`calle`,`numero`,`comuna`,`region`,`pais`) values 
(3,1,'Nudo Curauma','630','Valparaiso','Valparaiso','Chile'),
(4,2,'Errazuriz','950','Valparaiso','Valparaiso','Chile'),
(5,3,'Blanco','750','Valparaiso','Valparaiso','Chile'),
(6,2,'Av Valparaiso','210','Valparaiso','Valparaiso','Peru'),
(7,2,'1 Norte','1150','Viña del Mar','Viña del Mar','Italia'),
(8,2,'15 Norte','2230','Viña del Mar','Viña del mar','Chile');
...
insert  into `propietarios`(`idPropietario`,`rutPropietario`,`nombre`,`fechaNacimiento`) values 
(1,'8760213-3','Carlos Armijo','1961-01-20 17:59:32'),
(2,'22585996-4','Juan Galdames','1950-01-10 09:13:33'),
(3,'11875989-6','Sonia Gonzalez','1955-01-13 09:14:41');
...
/* Procedure structure for procedure `sp_PaisesArriendoPromedioMasAlto` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_PaisesArriendoPromedioMasAlto` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`admin`@`localhost` PROCEDURE `sp_PaisesArriendoPromedioMasAlto`()
BEGIN
		/*
			Se Pide: Indicar cuales son los 3 paises que el monto promedio de arriendo son los mas altos
		*/
		
		SELECT  p.pais ,
			FLOOR( AVG( a.monto ) ) AS monto
		FROM  arriendos a
		INNER 	JOIN propiedad    p ON a.idPropiedad     = 	p.idPropiedad
		GROUP BY p.pais
		ORDER BY monto DESC
...
/* Procedure structure for procedure `sp_Promedio_Minimo_Maximo` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_Promedio_Minimo_Maximo` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`admin`@`localhost` PROCEDURE `sp_Promedio_Minimo_Maximo`()
BEGIN
		/*
			Se Pide: Indicar montos Promedio, Minimo y Maximo que pagan Arrendatarios que tambien son Propietarios
		*/
		
		SELECT 	FLOOR( AVG(a.monto ) ) AS Promedio	,
			FLOOR( MIN(a.monto ) ) AS Minimo	,
			FLOOR( MAX(a.monto ) ) AS Maximo	
		FROM 	arriendos a
		INNER 	JOIN propiedad    p ON a.idPropiedad     = 	p.idPropiedad
		INNER	JOIN arrendatario b ON a.idArrendatario  = 	b.idArrendatario ;
    END */$$
