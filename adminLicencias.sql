...
MySQL - 10.3.32-MariaDB-0ubuntu0.20.04.1 : Database - adminLicencias
*********************************************************************
*/
...
CREATE TABLE `LOG_licencia` (
  ...
  CONSTRAINT `LOG_licencia_ibfk_6` FOREIGN KEY (`idLicencia`) REFERENCES `licencia_Tramite` (`idLicenciaTramite`),
...
(27,'Oftalmología'),
(28,'Oncología Médica'),
(29,'Ortopedia Y Traumatología'),
(30,'Otorrinolaringología'),
(31,'Pediatría'),
(32,'Psiquiatría'),
(33,'Psiquiatría Infantil y de la Adolescencia'),
(34,'Radiología'),
(35,'Radioterapia Oncológica'),
(36,'Reumatología'),
(37,'Salud Pública'),
(38,'Urología');
...
LOCK TABLES `licencia_Documento` WRITE;

insert  into `licencia_Documento`(`idLicenciaDocumento`,`idLicenciaTipo`,`describeLicenciaDocumento`) values 
(1,1,'Tres liquidaciones de sueldos anteriores al mes de inicio del reposo'),
(2,1,'Cotizaciones Previsionales AFP de los 12 ultimos meses anteriores al inicio del reposo'),
(3,1,'Copia o Anexo del contrato de trabajo vigente'),
(4,2,'Tres liquidaciones de sueldos anteriores al mes de inicio del reposo'),
(5,2,'Cotizaciones Previsionales AFP de los 12 ultimos meses anteriores al inicio del reposo'),
(6,2,'Copia o Anexo del contrato de trabajo vigente'),
(7,3,'Tres liquidaciones de sueldos anteriores al mes de inicio del reposo'),
(8,3,'Tres liquidaciones de sueldos anteriores al 7° mes de inicio del reposo'),
(9,3,'Cotizaciones Previsionales AFP de los 14 ultimos meses anteriores al inicio del reposo'),
(10,3,'Copia o Anexo del contrato de trabajo vigente'),
(11,4,'Tres liquidaciones de sueldos anteriores al mes de inicio del reposo'),
(12,4,'Cotizaciones Previsionales AFP de los 12 ultimos meses anteriores al inicio del reposo'),
(13,4,'Copia o Anexo del contrato de trabajo vigente');
...
LOCK TABLES `licencia_DocumentoRechazado` WRITE;
...
LOCK TABLES `licencia_DocumentosPresentados` WRITE;
...
LOCK TABLES `licencia_FormaPresenta` WRITE;

insert  into `licencia_FormaPresenta`(`idLicenciaFormaPresenta`,`describeLicenciaFormaPresenta`) values 
(1,'Electronica'),
(2,'Manual'),
(3,'Mixta');
...
LOCK TABLES `licencia_Rechazada` WRITE;
...
LOCK TABLES `licencia_Tipo` WRITE;

insert  into `licencia_Tipo`(`idLicenciaTipo`,`describeLicenciaTipo`) values 
...
LOCK TABLES `licencia_Tramite` WRITE;
...
LOCK TABLES `licencia_Workflow` WRITE;

insert  into `licencia_Workflow`(`idLicenciaWorkflow`,`describeLicenciaWorkFlow`,`idProcesoSiguiente`) values 
(1,'Licencia Ingresada al Sistema ',2),
(2,'Licencia Asociando Documentación Requerida',3),
(3,'Licencia en Validación',4),
(4,'Licencia Enviada a Compin',0),
(5,'Licencia Autorizada por Compin',6),
(6,'Licencia Enviada a Pago',7),
(7,'Licencia con Pago Autorizado',8),
(8,'Licencia Pago Electronico',0),
(9,'Licencia Pagada en Sucursal',0),
(10,'Licencia Rechazada',11),
(11,'Licencia con Apelación',12),
(12,'Licencia Apelada y Aceptada',4),
(13,'Licencia Apelada y Rechazada',0);
...
LOCK TABLES `recepcion_Documentos` WRITE;

insert  into `recepcion_Documentos`(`idRecepcionDocumentos`,`describeRecepcionDocumentos`) values 
(1,'Sucursal Habilitada para Recepcion de Documentos'),
(2,'Sucursal No Apta para Recepcion de Documentos');
...
LOCK TABLES `rechazo_Documento_Causal` WRITE;
...
LOCK TABLES `rechazo_Licencia_Causal` WRITE;

insert  into `rechazo_Licencia_Causal`(`idRechazoCausal`,`decribeRechazoCausal`) values 
(1,'Reposo Injustificado'),
(2,'Reducción de reposo'),
(3,'Diagnóstico irrecuperable'),
(4,'Incumplimiento de reposo'),
(5,'Fuera de Plazo'),
(6,'Falta Vínculo laboral'),
(7,'Enmendadura');
...
insert  into `region`(`idRegion`,`nombreRegion`,`ordinalRegion`) values 
...
(13,'Los Lagos','X'),
(14,'Aisen','XI'),
(15,'Magallanes y de la Antartica','XII'),
(16,'Sin Asignar','0000');
...
LOCK TABLES `trabajador_Afiliado` WRITE;
